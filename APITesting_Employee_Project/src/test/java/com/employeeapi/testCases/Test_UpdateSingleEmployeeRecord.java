...
public class Test_UpdateSingleEmployeeRecord extends TestBase {
	...
	void createlEmployees() throws InterruptedException {
		logger.info("****************Started Test_UpdateSingleEmployeeRecord*****************");
	...
	@AfterClass
	void tearDown() {
		logger.info("****************Finished Test_UpdateSingleEmployeeRecord*****************");
	}
}